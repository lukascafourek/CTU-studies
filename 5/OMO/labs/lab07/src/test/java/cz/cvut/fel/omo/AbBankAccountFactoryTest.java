...
public class AbBankAccountFactoryTest {

    AbBankFactory factory;

    @Before
    public void setUp() {
        factory = new AbBankFactory();
    }

    @Test
    public void createBankOffice_createNewBankOfficeInstance_bankOfficeInstanceIsReady() {
        // arrange
        String expectedPhoneNubmer = "420-2-777-777-777";
        String expectedAddress = "Ab Banka, Náměstí 2, Praha 1";
    ...
    public void createLoan_createNewLoan_monthlyPaymentIsCaclulated() {
        ...
        MonetaryAmount expectedMonthlyPayment = Money.of(60.8333333333333334, "EUR");
